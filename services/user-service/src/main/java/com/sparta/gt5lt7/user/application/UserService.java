package com.sparta.gt5lt7.user.application;

import com.sparta.gt5lt7.common.exception.BaseException;
import com.sparta.gt5lt7.common.security.JwtTokenProvider;
...
import com.sparta.gt5lt7.user.domain.repository.UserRepository;
import com.sparta.gt5lt7.user.global.exception.UserErrorCode;
...
public class UserService {
    ...
    public Page<User> searchUsers(UserSearchCondition condition, Pageable pageable) {
        ...
        return userRepository.searchUsers(condition, pageable);  // ← map 제거
    }
}